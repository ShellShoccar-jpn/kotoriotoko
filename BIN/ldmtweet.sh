...
print_usage_and_exit () {
  cat <<-USAGE 1>&2
	Usage   : ${0##*/} [options] DM#1 [DM#2 [...]]
	          cat /PATH/TO/SOURCE_OF_ONE-LINE-DMs | ${0##*/} [options]
	...
	Version : 2022-01-04 21:40:55 JST
	USAGE
  exit 1
}
error_exit() {
...
# (1)endpoint
API_endpt='https://api.twitter.com/1.1/direct_messages/events/new.json'
API_methd='POST'
# (2)parameters
API_param=`cat <<-PARAM                                                       |
